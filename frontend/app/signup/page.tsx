...
/** Signup screen: email/password with show/hide, uses AuthContext.register */
export default function SignupPage() {
  ...
  useEffect(() => {
    document.title = "Sign Up | Notes App";
  }, []);
    ...
    <div className="min-h-screen flex items-center justify-center p-4 md:p-8 relative overflow-hidden">
      <div className="relative z-10 w-full max-w-md">
        <div className="flex justify-center mb-4 md:mb-6">
          <Image src="/cat-signup.svg" alt="Cute sleeping cat" width={256} height={256} className="w-40 md:w-64 h-auto" sizes="(max-width: 768px) 10rem, 16rem" />
        </div>
